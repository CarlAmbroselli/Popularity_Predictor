...
comments = pd.read_csv('../data/datasets/raw/ynacc/ydata-ynacc-v1_0_expert_annotations.tsv', sep='\t')
...
comments.to_csv('../data/datasets/raw/ynacc/ydata-ynacc-v1_0_expert_annotations_de.tsv')
